...
describe('@Json', function () {
  ...
  it('allows the injected functions to be overridden without breaking the internal dependencies', function () {
    ...
    expect(this.t[modelSymbols.toJson]().ap)
      .toBe('test');
    expect(this.t[modelSymbols.toJson]().anp)
      .toBeUndefined();
    expect(this.t[modelSymbols.toJson]().aThirdProperty)
      .toBe(777);
    expect(this.t[modelSymbols.toJson]().aFunction)
      .toBeUndefined();
  ...
  it('works like a normal object when not decorated with @Json properties', function () {
    expect(this.t2.toJson().aProperty)
      .toBe('test');
    expect(this.t2.toJson().anotherProperty)
      .toBeUndefined();
    expect(this.t2.toJson().aThirdProperty)
      .toBe(777);
    expect(this.t2.toJson().aFunction)
      .toBeUndefined();
  });

  describe('toJson', function () {
    it('is injected into the prototype of the model by default', function () {
      expect(this.t.toJson)
        .toBeDefined();
    });

    it('transforms a defined property to the designated fieldName in the output of toJson', function () {
      expect(this.t.toJson().ap)
        .toBe('test');
      expect(this.t.toJson().anp)
        .toBeUndefined();
      expect(this.t.toJson().aThirdProperty)
        .toBe(777);
      expect(this.t.toJson().aFunction)
        .toBeUndefined();

      expect(this.t.aProperty)
        .toBe('test');
      expect(this.t.anotherProperty)
        .toBeUndefined();
      expect(this.t.aThirdProperty)
        .toBe(777);
    });
  });
  ...
  describe('fromJson', function () {
    ...
    describe('behaves such that it', function () {
      ...
      it('passes on constructor arguments to the @Model target being returned', function () {
        ...
        expect(obj.constructedProperty)
          .toBe(888);
        expect(obj.constructedProperty2)
          .toBe(999);
      });
      ...
      it('does not throw if there are no @Json decorators', function () {
        ...
        expect(() => C.fromJson({someProperty: 888}))
          .not
          .toThrow();
        expect(C.fromJson({someProperty: 888}).someProperty)
          .toBe(888);
      });
      ...
      it('returns a real @Model object, not just an object with the right properties', function () {
        expect(Test.fromJson({}).aFunction)
          .toBeDefined();
      });

      it('returns null when no json object is provided', function () {
        expect((<any>Test.fromJson)())
          .toBe(null);
        expect(Test.fromJson(null))
          .toBe(null);
        expect(Test.fromJson(undefined))
          .toBe(null);
      });
    });
  });
